...
if __name__ == '__main__':
    main()
# This code is part of a lesson on creating a GUI application using Tkinter.
# It implements an AQI monitoring system that allows users to load, filter, and view air